...
const saveServiceEdits = async () => {
  ...
  const downloadSampleFile = () => {
    const sampleData = [
      { SERVICE: 'TYPE -> (2/4/other)', 'BIKE': 2, 'SEDAN / MINI SUV': 4, 'SUV/ PREMIUM SEDAN': 4, 'PREMIUM SUV': 4 },
      { SERVICE: 'FULL WASH', 'BIKE': 500, 'SEDAN / MINI SUV': 600, 'SUV/ PREMIUM SEDAN': 700, 'PREMIUM SUV': 800 },
      { SERVICE: 'BODY WASH', 'BIKE': 400, 'SEDAN / MINI SUV': 500, 'SUV/ PREMIUM SEDAN': 600, 'PREMIUM SUV': 700 },
      { SERVICE: 'PREMIUM WASH', 'BIKE': 800, 'SEDAN / MINI SUV': 900, 'SUV/ PREMIUM SEDAN': 1000, 'PREMIUM SUV': 1100 },
      { SERVICE: 'CERAMIC WASH', 'BIKE': 1500, 'SEDAN / MINI SUV': 1500, 'SUV/ PREMIUM SEDAN': 1600, 'PREMIUM SUV': 1600 },
      { SERVICE: 'INTERIOR DEEP CLEANING', 'BIKE': 2000, 'SEDAN / MINI SUV': 2500, 'SUV/ PREMIUM SEDAN': 3000, 'PREMIUM SUV': 3500 },
      { SERVICE: 'EXTERIOR DETAILING', 'BIKE': 4000, 'SEDAN / MINI SUV': 5000, 'SUV/ PREMIUM SEDAN': 6000, 'PREMIUM SUV': 7000 },
      { SERVICE: 'UNDER BODY COATING', 'BIKE': 3500, 'SEDAN / MINI SUV': 4000, 'SUV/ PREMIUM SEDAN': 4500, 'PREMIUM SUV': 5000 }
    ];
